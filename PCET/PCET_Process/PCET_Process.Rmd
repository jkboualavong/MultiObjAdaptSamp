...
I am interested in how likely a randomly selected set of inputs will generate good or bad results, what the average result would be, and what the range of possible results is.
This will be assessed using the relative variable functions since they are easier to sample from (rectangular constraints).
The expected value will be the mean among the multiple surrogate models.

For a point:
* Determine its energy and flux (average among model outputs)
...
The remainder of this analysis will solely be in terms of natural variables.
