...
Additionally, the interest is in removing the conditions that have a <5% likelihood of capturing CO2, regardless of the other variables.

```{r CO2 Capture Marginalization}
GPar.all = read.csv(file = 'GPar_90Cap_data.csv')
...
fill.sample.obj.opt = function(x, model.flux, model.ener){
  ...
  # flux is faster than the maximum (which still meets the energy criteria)
...
The high flux region is fluxes above 22 mmol/m^2*s, while the low energy region is below 15 kJ/mol:
