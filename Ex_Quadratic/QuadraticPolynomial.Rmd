...
gplt.start = ggplot() +
  ...
  plot.present() + theme(legend.position = c(0.85, 0.2), legend.background = element_rect(fill = 'white', linetype = 1, color = 'black'), legend.title = element_blank())
...
gplt.GPar = ggplot() +
  ...
  labs(x = "Function 1", y = "Function 2", color = "") +  
  scale_color_discrete(labels = c('Starting Data', 'Pareto Search'), breaks = c(FALSE, TRUE)) +
  plot.present() + theme(legend.position = c(0.85, 0.3), legend.background = element_rect(fill = 'white', linetype = 1, color = 'black'), legend.title = element_blank())
